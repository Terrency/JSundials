...
/**
 * JNA Wrapper for library <b>SundialsNvecserial</b><br>
 * This file was autogenerated by <a href="http://jnaerator.googlecode.com/">JNAerator</a>,<br>
 * a tool written by <a href="http://ochafik.com/">Olivier Chafik</a> that <a href="http://code.google.com/p/jnaerator/wiki/CreditsAndLicense">uses a few opensource projects.</a>.<br>
 * For help, please visit <a href="http://nativelibs4java.googlecode.com/">NativeLibs4Java</a> , <a href="http://rococoa.dev.java.net/">Rococoa</a>, or <a href="http://jna.dev.java.net/">JNA</a>.
 */
public interface SundialsNvecserialLibrary extends Library {
	public static final String JNA_LIBRARY_NAME = "SundialsNvecserial";
	public static final NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(SundialsNvecserialLibrary.JNA_LIBRARY_NAME);
	public static final SundialsNvecserialLibrary INSTANCE = (SundialsNvecserialLibrary)Native.loadLibrary(SundialsNvecserialLibrary.JNA_LIBRARY_NAME, SundialsNvecserialLibrary.class);
	/**
	 * -----------------------------------------------------------------<br>
	 ...
	 */
	@Deprecated 
	N_Vector N_VNewEmpty_Serial(Pointer vec_length, Pointer sunctx);
	/**
	 * -----------------------------------------------------------------<br>
	 * Functions exported by nvector_serial<br>
	 * -----------------------------------------------------------------<br>
	 ...
	 */
	@Deprecated 
	N_Vector N_VNew_Serial(Pointer vec_length, Pointer sunctx);
	/**
	 * Original signature : <code>N_Vector N_VNew_Serial(sunindextype, SUNContext)</code><br>
	 ...
	 */
	@Deprecated 
	N_Vector N_VMake_Serial(Pointer vec_length, sunrealtype v_data, Pointer sunctx);
	/**
	 * Original signature : <code>N_Vector N_VMake_Serial(sunindextype, sunrealtype*, SUNContext)</code><br>
	 ...
	 */
	int N_VGetVectorID_Serial(N_Vector v);
	/**
	 ...
	 * @deprecated use the safer method {@link #N_VSpace_Serial(N_Vector, PointerByReference, PointerByReference)} instead
	 */
	@Deprecated 
	void N_VSpace_Serial(N_Vector v, Pointer lrw, Pointer liw);
	/**
	 * Original signature : <code>void N_VSpace_Serial(N_Vector, sunindextype*, sunindextype*)</code><br>
	 * <i>native declaration : include\nvector\nvector_serial.h:78</i>
	 */
	void N_VSpace_Serial(N_Vector v, PointerByReference lrw, PointerByReference liw);
	/**
	 ...
	 */
	int N_VLinearCombination_Serial(int nvec, sunrealtype c, N_Vector V, N_Vector z);
	/**
	 ...
	 */
	int N_VLinearSumVectorArray_Serial(int nvec, sunrealtype a, N_Vector X, sunrealtype b, N_Vector Y, N_Vector Z);
	/**
	 ...
	 */
	int N_VWrmsNormVectorArray_Serial(int nvecs, N_Vector X, N_Vector W, sunrealtype nrm);
	/**
	 ...
	 */
	int N_VWrmsNormMaskVectorArray_Serial(int nvecs, N_Vector X, N_Vector W, N_Vector id, sunrealtype nrm);
	/**
	 ...
	 * @deprecated use the safer method {@link #N_VScaleAddMultiVectorArray_Serial(int, int, sunrealtype, N_Vector, N_Vector[], N_Vector[])} instead
	 */
	@Deprecated 
	int N_VScaleAddMultiVectorArray_Serial(int nvec, int nsum, sunrealtype a, N_Vector X, PointerByReference Y, PointerByReference Z);
	/**
	 * Original signature : <code>SUNErrCode N_VScaleAddMultiVectorArray_Serial(int, int, sunrealtype*, N_Vector*, N_Vector**, N_Vector**)</code><br>
	 * <i>native declaration : include\nvector\nvector_serial.h:177</i>
	 */
	int N_VScaleAddMultiVectorArray_Serial(int nvec, int nsum, sunrealtype a, N_Vector X, N_Vector Y[], N_Vector Z[]);
	/**
	 ...
	 * @deprecated use the safer method {@link #N_VLinearCombinationVectorArray_Serial(int, int, sunrealtype, N_Vector[], N_Vector)} instead
	 */
	@Deprecated 
	int N_VLinearCombinationVectorArray_Serial(int nvec, int nsum, sunrealtype c, PointerByReference X, N_Vector Z);
	/**
	 * Original signature : <code>SUNErrCode N_VLinearCombinationVectorArray_Serial(int, int, sunrealtype*, N_Vector**, N_Vector*)</code><br>
	 * <i>native declaration : include\nvector\nvector_serial.h:182</i>
	 */
	int N_VLinearCombinationVectorArray_Serial(int nvec, int nsum, sunrealtype c, N_Vector X[], N_Vector Z);
	/**
	 ...
	 * @deprecated use the safer method {@link #N_VBufSize_Serial(N_Vector, PointerByReference)} instead
	 */
	@Deprecated 
	int N_VBufSize_Serial(N_Vector x, Pointer size);
	/**
	 * OPTIONAL XBraid interface operations<br>
	 * Original signature : <code>SUNErrCode N_VBufSize_Serial(N_Vector, sunindextype*)</code><br>
	 * <i>native declaration : include\nvector\nvector_serial.h:195</i>
	 */
	int N_VBufSize_Serial(N_Vector x, PointerByReference size);
	/**
	 * Original signature : <code>SUNErrCode N_VBufPack_Serial(N_Vector, void*)</code><br>
	 * <i>native declaration : include\nvector\nvector_serial.h:198</i>
	 */
	int N_VBufPack_Serial(N_Vector x, Pointer buf);
	/**
	 * Original signature : <code>SUNErrCode N_VBufUnpack_Serial(N_Vector, void*)</code><br>
	 * <i>native declaration : include\nvector\nvector_serial.h:201</i>
	 */
	int N_VBufUnpack_Serial(N_Vector x, Pointer buf);
	/**
	 * -----------------------------------------------------------------<br>
