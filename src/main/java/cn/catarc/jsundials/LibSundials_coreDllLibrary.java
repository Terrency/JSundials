...
/**
 * JNA Wrapper for library <b>lib\sundials_core.dll</b><br>
 * This file was autogenerated by <a href="http://jnaerator.googlecode.com/">JNAerator</a>,<br>
 * a tool written by <a href="http://ochafik.com/">Olivier Chafik</a> that <a href="http://code.google.com/p/jnaerator/wiki/CreditsAndLicense">uses a few opensource projects.</a>.<br>
 * For help, please visit <a href="http://nativelibs4java.googlecode.com/">NativeLibs4Java</a> , <a href="http://rococoa.dev.java.net/">Rococoa</a>, or <a href="http://jna.dev.java.net/">JNA</a>.
 */
public interface LibSundials_coreDllLibrary extends Library {
	public static final String JNA_LIBRARY_NAME = "lib\\sundials_core.dll";
	public static final NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(LibSundials_coreDllLibrary.JNA_LIBRARY_NAME);
	public static final LibSundials_coreDllLibrary INSTANCE = (LibSundials_coreDllLibrary)Native.loadLibrary(LibSundials_coreDllLibrary.JNA_LIBRARY_NAME, LibSundials_coreDllLibrary.class);
	/**
	 ...
	 * @deprecated use the safer method {@link #N_VSpace(_generic_N_Vector, PointerByReference, PointerByReference)} instead
	 */
	@Deprecated 
	void N_VSpace(_generic_N_Vector v, Pointer lrw, Pointer liw);
	/**
	 * Original signature : <code>void N_VSpace(N_Vector, sunindextype*, sunindextype*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:167</i>
	 */
	void N_VSpace(_generic_N_Vector v, PointerByReference lrw, PointerByReference liw);
	/**
	 ...
	 */
	sunrealtype N_VGetArrayPointer(_generic_N_Vector v);
	/**
	 ...
	 */
	sunrealtype N_VGetDeviceArrayPointer(_generic_N_Vector v);
	/**
	 ...
	 */
	void N_VSetArrayPointer(sunrealtype v_data, _generic_N_Vector v);
	/**
	 ...
	 */
	sunindextype N_VGetLength(_generic_N_Vector v);
	/**
	 ...
	 */
	sunindextype N_VGetLocalLength(_generic_N_Vector v);
	/**
	 ...
	 */
	void N_VLinearSum(sunrealtype a, _generic_N_Vector x, sunrealtype b, _generic_N_Vector y, _generic_N_Vector z);
	/**
	 ...
	 */
	void N_VConst(sunrealtype c, _generic_N_Vector z);
	/**
	 ...
	 */
	void N_VScale(sunrealtype c, _generic_N_Vector x, _generic_N_Vector z);
	/**
	 ...
	 */
	void N_VAddConst(_generic_N_Vector x, sunrealtype b, _generic_N_Vector z);
	/**
	 ...
	 */
	sunrealtype N_VDotProd(_generic_N_Vector x, _generic_N_Vector y);
	/**
	 ...
	 */
	sunrealtype N_VMaxNorm(_generic_N_Vector x);
	/**
	 ...
	 */
	sunrealtype N_VWrmsNorm(_generic_N_Vector x, _generic_N_Vector w);
	/**
	 ...
	 */
	sunrealtype N_VWrmsNormMask(_generic_N_Vector x, _generic_N_Vector w, _generic_N_Vector id);
	/**
	 ...
	 */
	sunrealtype N_VMin(_generic_N_Vector x);
	/**
	 ...
	 */
	sunrealtype N_VWL2Norm(_generic_N_Vector x, _generic_N_Vector w);
	/**
	 ...
	 */
	sunrealtype N_VL1Norm(_generic_N_Vector x);
	/**
	 ...
	 */
	void N_VCompare(sunrealtype c, _generic_N_Vector x, _generic_N_Vector z);
	/**
	 ...
	 */
	sunrealtype N_VMinQuotient(_generic_N_Vector num, _generic_N_Vector denom);
	/**
	 ...
	 * <i>native declaration : include\sundials\sundials_nvector.h:203</i><br>
	 * @deprecated use the safer method {@link #N_VLinearCombination(int, sunrealtype, ByReference[], _generic_N_Vector)} instead
	 */
	@Deprecated 
	int N_VLinearCombination(int nvec, sunrealtype c, PointerByReference X, _generic_N_Vector z);
	/**
	 * fused vector operations<br>
	 * Original signature : <code>SUNErrCode N_VLinearCombination(int, sunrealtype*, N_Vector*, N_Vector)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:203</i>
	 */
	int N_VLinearCombination(int nvec, sunrealtype c, ByReference X[], _generic_N_Vector z);
	/**
	 * Original signature : <code>SUNErrCode N_VScaleAddMulti(int, sunrealtype*, N_Vector, N_Vector*, N_Vector*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:207</i><br>
	 * @deprecated use the safer method {@link #N_VScaleAddMulti(int, sunrealtype, _generic_N_Vector, ByReference[], ByReference[])} instead
	 */
	@Deprecated 
	int N_VScaleAddMulti(int nvec, sunrealtype a, _generic_N_Vector x, PointerByReference Y, PointerByReference Z);
	/**
	 * Original signature : <code>SUNErrCode N_VScaleAddMulti(int, sunrealtype*, N_Vector, N_Vector*, N_Vector*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:207</i>
	 */
	int N_VScaleAddMulti(int nvec, sunrealtype a, _generic_N_Vector x, ByReference Y[], ByReference Z[]);
	/**
	 * Original signature : <code>SUNErrCode N_VDotProdMulti(int, N_Vector, N_Vector*, sunrealtype*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:211</i><br>
	 * @deprecated use the safer method {@link #N_VDotProdMulti(int, _generic_N_Vector, ByReference[], sunrealtype)} instead
	 */
	@Deprecated 
	int N_VDotProdMulti(int nvec, _generic_N_Vector x, PointerByReference Y, sunrealtype dotprods);
	/**
	 * Original signature : <code>SUNErrCode N_VDotProdMulti(int, N_Vector, N_Vector*, sunrealtype*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:211</i>
	 */
	int N_VDotProdMulti(int nvec, _generic_N_Vector x, ByReference Y[], sunrealtype dotprods);
	/**
	 ...
	 * <i>native declaration : include\sundials\sundials_nvector.h:216</i><br>
	 * @deprecated use the safer method {@link #N_VLinearSumVectorArray(int, sunrealtype, ByReference[], sunrealtype, ByReference[], ByReference[])} instead
	 */
	@Deprecated 
	int N_VLinearSumVectorArray(int nvec, sunrealtype a, PointerByReference X, sunrealtype b, PointerByReference Y, PointerByReference Z);
	/**
	 * vector array operations<br>
	 * Original signature : <code>SUNErrCode N_VLinearSumVectorArray(int, sunrealtype, N_Vector*, sunrealtype, N_Vector*, N_Vector*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:216</i>
	 */
	int N_VLinearSumVectorArray(int nvec, sunrealtype a, ByReference X[], sunrealtype b, ByReference Y[], ByReference Z[]);
	/**
	 * Original signature : <code>SUNErrCode N_VScaleVectorArray(int, sunrealtype*, N_Vector*, N_Vector*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:220</i><br>
	 * @deprecated use the safer method {@link #N_VScaleVectorArray(int, sunrealtype, ByReference[], ByReference[])} instead
	 */
	@Deprecated 
	int N_VScaleVectorArray(int nvec, sunrealtype c, PointerByReference X, PointerByReference Z);
	/**
	 * Original signature : <code>SUNErrCode N_VScaleVectorArray(int, sunrealtype*, N_Vector*, N_Vector*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:220</i>
	 */
	int N_VScaleVectorArray(int nvec, sunrealtype c, ByReference X[], ByReference Z[]);
	/**
	 * Original signature : <code>SUNErrCode N_VConstVectorArray(int, sunrealtype, N_Vector*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:224</i><br>
	 * @deprecated use the safer method {@link #N_VConstVectorArray(int, sunrealtype, ByReference[])} instead
	 */
	@Deprecated 
	int N_VConstVectorArray(int nvec, sunrealtype c, PointerByReference Z);
	/**
	 * Original signature : <code>SUNErrCode N_VConstVectorArray(int, sunrealtype, N_Vector*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:224</i>
	 */
	int N_VConstVectorArray(int nvec, sunrealtype c, ByReference Z[]);
	/**
	 * Original signature : <code>SUNErrCode N_VWrmsNormVectorArray(int, N_Vector*, N_Vector*, sunrealtype*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:227</i><br>
	 * @deprecated use the safer method {@link #N_VWrmsNormVectorArray(int, ByReference[], ByReference[], sunrealtype)} instead
	 */
	@Deprecated 
	int N_VWrmsNormVectorArray(int nvec, PointerByReference X, PointerByReference W, sunrealtype nrm);
	/**
	 * Original signature : <code>SUNErrCode N_VWrmsNormVectorArray(int, N_Vector*, N_Vector*, sunrealtype*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:227</i>
	 */
	int N_VWrmsNormVectorArray(int nvec, ByReference X[], ByReference W[], sunrealtype nrm);
	/**
	 * Original signature : <code>SUNErrCode N_VWrmsNormMaskVectorArray(int, N_Vector*, N_Vector*, N_Vector, sunrealtype*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:231</i><br>
	 * @deprecated use the safer method {@link #N_VWrmsNormMaskVectorArray(int, ByReference[], ByReference[], _generic_N_Vector, sunrealtype)} instead
	 */
	@Deprecated 
	int N_VWrmsNormMaskVectorArray(int nvec, PointerByReference X, PointerByReference W, _generic_N_Vector id, sunrealtype nrm);
	/**
	 * Original signature : <code>SUNErrCode N_VWrmsNormMaskVectorArray(int, N_Vector*, N_Vector*, N_Vector, sunrealtype*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:231</i>
	 */
	int N_VWrmsNormMaskVectorArray(int nvec, ByReference X[], ByReference W[], _generic_N_Vector id, sunrealtype nrm);
	/**
	 ...
	 * @deprecated use the safer method {@link #N_VScaleAddMultiVectorArray(int, int, sunrealtype, ByReference[], PointerByReference, PointerByReference)} instead
	 */
	@Deprecated 
	int N_VScaleAddMultiVectorArray(int nvec, int nsum, sunrealtype a, PointerByReference X, PointerByReference Y, PointerByReference Z);
	/**
	 * Original signature : <code>SUNErrCode N_VScaleAddMultiVectorArray(int, int, sunrealtype*, N_Vector*, N_Vector**, N_Vector**)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:235</i>
	 */
	int N_VScaleAddMultiVectorArray(int nvec, int nsum, sunrealtype a, ByReference X[], PointerByReference Y, PointerByReference Z);
	/**
	 ...
	 * @deprecated use the safer method {@link #N_VLinearCombinationVectorArray(int, int, sunrealtype, PointerByReference, ByReference[])} instead
	 */
	@Deprecated 
	int N_VLinearCombinationVectorArray(int nvec, int nsum, sunrealtype c, PointerByReference X, PointerByReference Z);
	/**
	 * Original signature : <code>SUNErrCode N_VLinearCombinationVectorArray(int, int, sunrealtype*, N_Vector**, N_Vector*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:239</i>
	 */
	int N_VLinearCombinationVectorArray(int nvec, int nsum, sunrealtype c, PointerByReference X, ByReference Z[]);
	/**
	 ...
	 */
	sunrealtype N_VDotProdLocal(_generic_N_Vector x, _generic_N_Vector y);
	/**
	 ...
	 */
	sunrealtype N_VMaxNormLocal(_generic_N_Vector x);
	/**
	 ...
	 */
	sunrealtype N_VMinLocal(_generic_N_Vector x);
	/**
	 ...
	 */
	sunrealtype N_VL1NormLocal(_generic_N_Vector x);
	/**
	 ...
	 */
	sunrealtype N_VWSqrSumLocal(_generic_N_Vector x, _generic_N_Vector w);
	/**
	 ...
	 */
	sunrealtype N_VWSqrSumMaskLocal(_generic_N_Vector x, _generic_N_Vector w, _generic_N_Vector id);
	/**
	 ...
	 */
	sunrealtype N_VMinQuotientLocal(_generic_N_Vector num, _generic_N_Vector denom);
	/**
	 ...
	 * @deprecated use the safer method {@link #N_VDotProdMultiLocal(int, _generic_N_Vector, ByReference[], sunrealtype)} instead
	 */
	@Deprecated 
	int N_VDotProdMultiLocal(int nvec, _generic_N_Vector x, PointerByReference Y, sunrealtype dotprods);
	/**
	 * single buffer reduction operations<br>
	 * Original signature : <code>SUNErrCode N_VDotProdMultiLocal(int, N_Vector, N_Vector*, sunrealtype*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:260</i>
	 */
	int N_VDotProdMultiLocal(int nvec, _generic_N_Vector x, ByReference Y[], sunrealtype dotprods);
	/**
	 ...
	 */
	int N_VDotProdMultiAllReduce(int nvec_total, _generic_N_Vector x, sunrealtype sum);
	/**
	 ...
	 * @deprecated use the safer method {@link #N_VBufSize(_generic_N_Vector, PointerByReference)} instead
	 */
	@Deprecated 
	int N_VBufSize(_generic_N_Vector x, Pointer size);
	/**
	 * XBraid interface operations<br>
	 * Original signature : <code>SUNErrCode N_VBufSize(N_Vector, sunindextype*)</code><br>
	 * <i>native declaration : include\sundials\sundials_nvector.h:266</i>
	 */
	int N_VBufSize(_generic_N_Vector x, PointerByReference size);
	/**
	 ...
	 */
	void N_VPrintFile(_generic_N_Vector v, FILE outfile);
