...
/**
 * JNA Wrapper for library <b>SundialsArkode</b><br>
 * This file was autogenerated by <a href="http://jnaerator.googlecode.com/">JNAerator</a>,<br>
 * a tool written by <a href="http://ochafik.com/">Olivier Chafik</a> that <a href="http://code.google.com/p/jnaerator/wiki/CreditsAndLicense">uses a few opensource projects.</a>.<br>
 * For help, please visit <a href="http://nativelibs4java.googlecode.com/">NativeLibs4Java</a> , <a href="http://rococoa.dev.java.net/">Rococoa</a>, or <a href="http://jna.dev.java.net/">JNA</a>.
 */
public interface SundialsArkodeLibrary extends Library {
	public static final String JNA_LIBRARY_NAME = "SundialsArkode";
	public static final NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(SundialsArkodeLibrary.JNA_LIBRARY_NAME);
	public static final SundialsArkodeLibrary INSTANCE = (SundialsArkodeLibrary)Native.loadLibrary(SundialsArkodeLibrary.JNA_LIBRARY_NAME, SundialsArkodeLibrary.class);
	/**
	...
	public interface ARKRwtFn extends Callback {
		int apply(N_Vector y, N_Vector rwt, Pointer user_data);
	};
	/** <i>native declaration : include\arkode\arkode.h</i> */
	public interface ARKAdaptFn extends Callback {
		int apply(N_Vector y, sunrealtype t, sunrealtype h1, sunrealtype h2, sunrealtype h3, sunrealtype e1, sunrealtype e2, sunrealtype e3, int q, int p, sunrealtype hnew, Pointer user_data);
	};
	/** <i>native declaration : include\arkode\arkode.h</i> */
	public interface ARKExpStabFn extends Callback {
		int apply(N_Vector y, sunrealtype t, sunrealtype hstab, Pointer user_data);
	};
	/** <i>native declaration : include\arkode\arkode.h</i> */
	public interface ARKVecResizeFn extends Callback {
		int apply(N_Vector y, N_Vector ytemplate, Pointer user_data);
	};
	/** <i>native declaration : include\arkode\arkode.h</i> */
	public interface ARKPostProcessFn extends Callback {
		int apply(sunrealtype t, N_Vector y, Pointer user_data);
	};
	/** <i>native declaration : include\arkode\arkode.h</i> */
	public interface ARKStagePredictFn extends Callback {
		int apply(sunrealtype t, N_Vector zpred, Pointer user_data);
	};
	/** <i>native declaration : include\arkode\arkode.h</i> */
	public interface ARKRelaxFn extends Callback {
		int apply(N_Vector y, sunrealtype r, Pointer user_data);
	};
	/** <i>native declaration : include\arkode\arkode.h</i> */
	public interface ARKRelaxJacFn extends Callback {
		int apply(N_Vector y, N_Vector J, Pointer user_data);
	};
	/**
	 * Utility routines to allocate/free/output Butcher table structures<br>
	 * Original signature : <code>ARKodeButcherTable ARKodeButcherTable_Alloc(int, sunbooleantype)</code><br>
	 * <i>native declaration : include\arkode\arkode_butcher.h:23</i>
	 */
	 ...
	 * <i>native declaration : include\arkode\arkode_butcher.h:25</i>
	 */
	 ...
	 * <i>native declaration : include\arkode\arkode_butcher.h:30</i>
	 */
	 ...
	 * <i>native declaration : include\arkode\arkode_butcher.h:31</i><br>
	 * @deprecated use the safer method {@link #ARKodeButcherTable_Space(ARKodeButcherTable, PointerByReference, PointerByReference)} instead
	 */
	@Deprecated 
	void ARKodeButcherTable_Space(ARKodeButcherTable B, Pointer liw, Pointer lrw);
	/**
	 * Original signature : <code>void ARKodeButcherTable_Space(ARKodeButcherTable, sunindextype*, sunindextype*)</code><br>
	 * <i>native declaration : include\arkode\arkode_butcher.h:31</i>
	 */
	void ARKodeButcherTable_Space(ARKodeButcherTable B, PointerByReference liw, PointerByReference lrw);
	/**
	 * Original signature : <code>void ARKodeButcherTable_Free(ARKodeButcherTable)</code><br>
	 * <i>native declaration : include\arkode\arkode_butcher.h:34</i>
	 */
	 ...
	 * <i>native declaration : include\arkode\arkode_butcher.h:35</i>
	 */
	void ARKodeButcherTable_Write(ARKodeButcherTable B, FILE outfile);
	/**
	 * Original signature : <code>sunbooleantype ARKodeButcherTable_IsStifflyAccurate(ARKodeButcherTable)</code><br>
	 * <i>native declaration : include\arkode\arkode_butcher.h:37</i>
	 */
	int ARKodeButcherTable_IsStifflyAccurate(ARKodeButcherTable B);
	/**
	 * Original signature : <code>int ARKodeButcherTable_CheckOrder(ARKodeButcherTable, int*, int*, FILE*)</code><br>
	 * <i>native declaration : include\arkode\arkode_butcher.h:39</i><br>
	 * @deprecated use the safer methods {@link #ARKodeButcherTable_CheckOrder(ARKodeButcherTable, IntBuffer, IntBuffer, FILE)} and {@link #ARKodeButcherTable_CheckOrder(ARKodeButcherTable, IntByReference, IntByReference, FILE)} instead
	 */
	@Deprecated 
	int ARKodeButcherTable_CheckOrder(ARKodeButcherTable B, IntByReference q, IntByReference p, FILE outfile);
	/**
	 * Original signature : <code>int ARKodeButcherTable_CheckOrder(ARKodeButcherTable, int*, int*, FILE*)</code><br>
	 * <i>native declaration : include\arkode\arkode_butcher.h:39</i>
	 */
	int ARKodeButcherTable_CheckOrder(ARKodeButcherTable B, IntBuffer q, IntBuffer p, FILE outfile);
	/**
	 * Original signature : <code>int ARKodeButcherTable_CheckARKOrder(ARKodeButcherTable, ARKodeButcherTable, int*, int*, FILE*)</code><br>
	 * <i>native declaration : include\arkode\arkode_butcher.h:41</i><br>
	 * @deprecated use the safer methods {@link #ARKodeButcherTable_CheckARKOrder(ARKodeButcherTable, ARKodeButcherTable, IntBuffer, IntBuffer, FILE)} and {@link #ARKodeButcherTable_CheckARKOrder(ARKodeButcherTable, ARKodeButcherTable, IntByReference, IntByReference, FILE)} instead
	 */
	@Deprecated 
	int ARKodeButcherTable_CheckARKOrder(ARKodeButcherTable B1, ARKodeButcherTable B2, IntByReference q, IntByReference p, FILE outfile);
	/**
	 * Original signature : <code>int ARKodeButcherTable_CheckARKOrder(ARKodeButcherTable, ARKodeButcherTable, int*, int*, FILE*)</code><br>
	 * <i>native declaration : include\arkode\arkode_butcher.h:41</i>
	 */
	int ARKodeButcherTable_CheckARKOrder(ARKodeButcherTable B1, ARKodeButcherTable B2, IntBuffer q, IntBuffer p, FILE outfile);
	public static class ARKodeButcherTable extends PointerType {
		public ARKodeButcherTable(Pointer address) {
			super(address);
		}
		public ARKodeButcherTable() {
			super();
		}
	};
}
